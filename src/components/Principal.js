    ...
    return (
        ...
        <div class="snap-y snap-mandatory h-screen w-full overflow-auto">
            ...
            <div id="principal" class="snap-start h-screen w-full">
                ...
                <div class="pt-2 pl-2">
                    <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full"
                        onClick={() => showAdminAlert()}><Link to="/login">Admin</Link></button>
                </div>
            ...
            <div class="snap-start h-screen w-full bg-green-100">
                ...
                <button class="pt-6 pl-2">
                    <a  target="_blank" without rel="noreferrer" href='https://drive.google.com/drive/folders/1hgG9Rf6JbIwVVTtCoSTcQ7pIdFRhfyMs?usp=sharing' class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full">DOWNLOAD APK</a>
                </button>
